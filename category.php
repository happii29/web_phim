...
<body>
    ...
    <section class="home container" id="home">
        <img src="img/4834463_cover_poster_matbiec.jpg" alt="" class="home-img">
        <div class="home-text">
            <h1 class="home-title">Mắt biếc</h1>
            <p>Tình cảm | Việt Nam | 2019</p>
            <a href="product.php?phim=44" class="watch-btn"><i class="bx bx-play"></i><span>Xem Phim</span></a>
        </div>
    </section>
    <!-- Phim chiếu rạp -->
    <section class="movies container" id="movies">
        ...
        <div class="movies-content">
            ...
            ?>
            <div class="movie-box">
                <img src="admin/uploads/<?php echo $row_title_product['product_img_desc'] ?>" class="movie-box-img">
                <div class="box-text">
                    <h2 class="movie-title"><?php echo $row_title_product['product_name'] ?></h2>
                    <span class="movie-type"><?php echo $row_title_product['product_category'] ?></span>
